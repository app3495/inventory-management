                ...
                @if (old ("code") !== null)
                    @for ($i = 1; $i <= count(old("code")); $i++)
                        <tr>
                            ...
                            <td class="text-end">
                                <select name="unit[{{$i}}]" id="unit[{{$i}}]" class="form-select" required>
                ...
                @else
                    ...
                    @foreach ($inventory as $item)
                        <tr>
                            ...
                            <td class="text-end">
                                <select name="unit[{{$counter}}]" id="unit[{{$counter}}]" class="form-select" disabled >
                                    <option>Choose units</option>
                            ...
                            <td class="text-end">
                                <input type="text" name="price[{{$counter}}]" id="price[{{$counter}}]" class="form-control text-end"
                                    onkeyup="calculate_total()" value="{{ number_format($item->price) }}" readonly required>
                            </td>
                            <td class="text-end">
                                <input type="text" name="qty[{{$counter}}]" id="qty[{{$counter}}]" class="form-control text-end" onkeyup="calculate_total()" value="{{ number_format($item->qty) }}" readonly >
                            </td>
                            <td class="text-end">
                                <input type="text" name="amount[{{$counter}}]" id="amount[{{$counter}}]" class="form-control text-end" value="{{ number_format($item->total) }}" readonly>
                            </td>
                        </tr>
                        @php
                            $counter++;
